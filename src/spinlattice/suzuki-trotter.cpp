...
namespace sld
{
	...
	void stats_sld()
	{
		...
		sld::J_eff = sld::compute_effective_J(0,atoms::num_atoms, sld::internal::sumJ);
      	sld::C_eff = sld::compute_effective_C(0,atoms::num_atoms, sld::internal::sumC);
   }
   	...
   	int suzuki_trotter()
	{
		...
		// ======
		// Velocity, position update - change for fixed lattice
		// ======
